...
- **Impressora**. No Windows acesse "Impressora e scanners", desmarque a opção "Deixe o Windows gerenciar minha impressora padrão". Selecione a impressora do Totem e marque como impressora padrão. Feito isso, realiza o teste de impressão.
